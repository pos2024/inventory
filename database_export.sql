...
// <![CDATA[
CommonParams.setAll({common_query:"lang=en",opendb_url:"index.php?route=/database/structure&lang=en",lang:"en",server:"1",table:"",db:"369860774_cmdc",token:"6548632c6b552d3525517e286f42687d",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:false,is_https:true,rootPath:"/",arg_separator:"&",version:"5.2.1",auth_type:"cookie",user:"root"});
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="index.php?route=/&lang=en" class="disableAjax">
          <input type="hidden" name="route" value="/database/export"><input type="hidden" name="db" value="369860774_cmdc"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="6548632c6b552d3525517e286f42687d">
...
<form method="post" id="login_form" action="index.php?route=/" name="login_form" class="disableAjax hide js-show">
    <input type="hidden" name="route" value="/database/export"><input type="hidden" name="db" value="369860774_cmdc"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="6548632c6b552d3525517e286f42687d">
  <input type="hidden" name="set_session" value="36c7842c710427ef6919f7106f72ef6d">
  ...
  <div class="card mb-4">
    ...
    <div class="card-footer">
              <script src="https://www.google.com/recaptcha/api.js?hl=en" async defer></script>
                  <input class="btn btn-primary g-recaptcha" data-sitekey="6LfQreMUAAAAAA5MTVLG00DP9mgCdtOb7DVvc0dn" data-callback="Functions_recaptchaCallback" value="Log in" type="submit" id="input_go">
                  </div>
  </div>
</form>
